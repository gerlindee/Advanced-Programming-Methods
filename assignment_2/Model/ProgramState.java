...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> es, IDictionary<String, Integer> st, IList<Integer> ot, IStatement program, IDictionary<Integer,Tuple<String, BufferedReader>> ft, IHeap hp) {
        this.exeStack = es;
        this.symTable = st;
        this.out = ot;
        this.fileTable = ft;
